...
class BaseParser {
  constructor(name) {
    this.name = name;
    this.stats = { checked: 0, parsed: 0, errors: 0, blockedPages: 0, errorPages: 0, unsupportedUrlPages: 0, driftPages: 0, snapshotsSaved: 0, browserFetches: 0, abortedByBotWall: false, abortedAt: null, earlyStoppedSeries: 0 };
    this.sourceIssues = [];
