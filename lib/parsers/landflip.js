...
// Acreage number uses the shared ACREAGE_NUMBER fragment (lib/acreage.js) so
// a leading-decimal figure like ".24 Acres : $45,000" parses as 0.24, not 24.
const PRICE_ACREAGE_RE = new RegExp(`(${ACREAGE_NUMBER})\\s*acres?\\s*:\\s*\\$\\s*(${ACREAGE_NUMBER})`, 'i');
...
const ACRES_IN_DESCRIPTION_RE = new RegExp(`\\bwith\\s+(${ACREAGE_NUMBER})\\s+acres?\\b`, 'i');
