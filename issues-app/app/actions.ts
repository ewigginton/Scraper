...
import { safeReturnTo as safeReturnToValue } from './_lib/safe-return-to.ts';
...
/** See app/_lib/safe-return-to.ts's doc comment for the full history/rationale. */
function safeReturnTo(formData: FormData, fallback = '/'): string {
  return safeReturnToValue(str(formData, 'returnTo'), fallback);
}
